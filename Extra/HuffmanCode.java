...
public class HuffmanCode {
    ...
    static JPanel mainPanel, subPanel;
    static JButton inputSetOfChar;
    static String text;
    ...
    public static void main(String[] args){
        ...
        inputSetOfChar = new JButton();

        mainFrame.setSize(1300, 700);
        mainFrame.setTitle("Huffman Coding");
        mainFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        mainFrame.setLocationRelativeTo(null);

        mainPanel.setLayout(null);
        mainPanel.setBackground(Color.decode("#FCF8E8"));
        mainPanel.setBounds(0,0,1000,700);
        mainFrame.add(mainPanel);

        subPanel.setLayout(null);
        subPanel.setBackground(Color.decode("#94B49F"));
        subPanel.setBounds(0,0,500,700);
        mainFrame.add(subPanel);

        JLabel numOfBits = new JLabel("NUMBER OF BITS");
        numOfBits.setFont(new Font("Verdana", Font.BOLD, 20));
        numOfBits.setBounds(1050, 200, 200,20);
        numOfBits.setForeground(Color.decode("#FCF8E8"));
        subPanel.add(numOfBits);

        JLabel asciiResult = new JLabel("ASCII: ");
        asciiResult.setFont(new Font("Verdana", Font.PLAIN, 15));
        asciiResult.setBounds(1100, 230, 200,20);
        asciiResult.setForeground(Color.decode("#FCF8E8"));
        subPanel.add(asciiResult);

        JLabel huffmanResult = new JLabel("HUFFMAN: ");
        huffmanResult.setFont(new Font("Verdana", Font.PLAIN, 15));
        huffmanResult.setBounds(1070, 250, 200,20);
        huffmanResult.setForeground(Color.decode("#FCF8E8"));
        subPanel.add(huffmanResult);

        JLabel percentageText = new JLabel("<html><center>Percentage of " +
                "<br>Storage Savings");
        percentageText.setFont(new Font("Verdana", Font.PLAIN, 15));
        percentageText.setBounds(1080, 400, 200,40);
        percentageText.setForeground(Color.decode("#FCF8E8"));
        subPanel.add(percentageText);

        //try muna
        JLabel percentage = new JLabel("0.00%");
        percentage.setFont(new Font("Verdana", Font.BOLD, 20));
        percentage.setBounds(1105, 450, 200,20);
        percentage.setForeground(Color.decode("#FCF8E8"));
        subPanel.add(percentage);

        JLabel title = new JLabel("HUFFMAN CODING");
        title.setForeground(Color.decode("#94B49F"));
        title.setFont(new Font("Verdana", Font.BOLD, 30));
        title.setBounds(350, 20, 1200, 30);
        mainPanel.add(title);

        JLabel description = new JLabel("<html><center>The program will" +
                " ask the user to input a series of characters as basis for" +
                "<br> the creation of the Huffman Code.");
        description.setFont(new Font("Verdana", Font.ITALIC, 12));
        description.setForeground(Color.decode("#DF7861"));
        description.setBounds(290, 40, 450, 50);
        mainPanel.add(description);

        JLabel input = new JLabel("Input a set of characters: ");
        input.setFont(new Font("Verdana", Font.PLAIN, 14));
        input.setBounds(150, 93, 1200,20);
        mainPanel.add(input);

        JTextField textFieldChar = new JTextField();
        textFieldChar.setBounds(350,90,200,20);
        textFieldChar.setSize(500, 30);
        textFieldChar.setCaretColor(Color.decode("#DF7861"));
        textFieldChar.setFont(new Font("Verdana", Font.PLAIN, 14));
        textFieldChar.setHorizontalAlignment(JTextField.CENTER);
        mainPanel.add(textFieldChar);

        JButton inputButton = new JButton("Input");
        inputButton.setBounds(350, 120, 100, 25);
        inputButton.setSize(500, 20);
        inputButton.setBackground(Color.decode("#94B49F"));
        inputButton.setForeground(Color.white);
        inputButton.setFocusable(false);
        mainPanel.add(inputButton);
        inputButton.addActionListener(e -> {
            text = textFieldChar.getText();
            if(!text.matches("[A-Za-z]+")){
                JOptionPane.showMessageDialog(null,"ERROR! Input must be a set of Characters!",
            ...
            System.out.println("""
                ...
                +================================================+
                      Choose from the following what to do next:
                       [1] Decode Sequence of Huffman Code
                       [2] Encode Text
                       [3] Create New Huffman Code
                       [4] Exit Program
                +================================================+""");
     ...
     * program which direction it should traverse. Recursion was used in order to traverse the huffman tree, if the
    ...
    /**
     * The isLeaf method checks if the current node a leaf of not. A leaf in a huffman tree
